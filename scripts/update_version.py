...
NEW_VERSION = "5.0.7"
NEW_BUILD_DATE = "2025-04-27"  # Format: YYYY-MM-DD (leave empty for today's date)
VA_PROFILE_VERSION = "5.0.7"  # Set to "" if this release does not include a VA profile update
# ====================================
