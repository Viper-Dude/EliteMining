...
NEW_VERSION = "5.0.6"
NEW_BUILD_DATE = "2025-04-21"  # Format: YYYY-MM-DD (leave empty for today's date)
VA_PROFILE_VERSION = "5.0.6"  # Set to "" if this release does not include a VA profile update
# ====================================
