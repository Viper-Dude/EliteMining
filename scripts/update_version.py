...
NEW_VERSION = "5.1.1"
NEW_BUILD_DATE = "2025-05-31"  # Format: YYYY-MM-DD (leave empty for today's date)
VA_PROFILE_VERSION = "5.1.1"  # Set to "" if this release does not include a VA profile update
# ====================================
