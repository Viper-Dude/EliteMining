...
NEW_VERSION = "5.2.5"
NEW_BUILD_DATE = "2026-July-20"  # Format: YYYY-MM-DD (leave empty for today's date)
VA_PROFILE_VERSION = "5.2.5"  # Set to "" if this release does not include a VA profile update
# ====================================
