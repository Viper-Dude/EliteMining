...
NEW_VERSION = "5.1.3"
NEW_BUILD_DATE = "2025-06-07"  # Format: YYYY-MM-DD (leave empty for today's date)
VA_PROFILE_VERSION = "5.1.3"  # Set to "" if this release does not include a VA profile update
# ====================================
