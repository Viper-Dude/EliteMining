...
- Distance results now show actual system names (e.g., "Distance HIP 96287 ↔ Paesia: 307.68 LY")
...
### Hotspots Finder
- Fixed ring scan highlighting nearby systems with same ring names (e.g., "1 A Ring") - now only highlights the exact scanned system+ring

### VoiceAttack Profile
- No changes - latest version is v4.6.0
