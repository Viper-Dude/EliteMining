...
* Fixed PowerPlay column sorting in Ring Finder and Star Systems so systems with no data now group together instead of appearing scattered.
* Fixed an issue where locally stored market data could become outdated and take longer to refresh.
