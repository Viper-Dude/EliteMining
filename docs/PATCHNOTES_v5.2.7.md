...
**Release Date:** 2026-July-25


### Bug Fixes

- Fixed the linked Announcement Preset being cleared when saving over a Ship Preset.
- Fixed the Powerplay column showing blank leftover text when searching for material traders.
...
* **Updating from a version older than v5.2.5?** Read the [v5.2.5 patch notes](https://github.com/Viper-Dude/EliteMining/releases/tag/5.2.5) first — it covers an important hotspot database change.
