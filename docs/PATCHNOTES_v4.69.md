...
### Mining Reports
- Fixed refinery materials being incorrectly added to wrong session reports
- Fixed "Save as New" preset dialog now pre-selects correct ship folder
- Fixed mining card generation error when no materials tracked
- Backup now includes TXT and PNG report files
